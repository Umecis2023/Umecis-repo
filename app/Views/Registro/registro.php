      ...
      <div class="row">
        <div class="col-md-6 text-center">
          <div class="panel panel-default">
            ...
            <p class="text-justify">Para unirte a la página de UMECIS debes ingresar CÓDIGO de Carrera-CÉDULA.
            ...
            <div class="panel-body">
              <form class="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" name="email" placeholder="Introduzca su nombre y apellido">
                </div>
                <div class="form-group">
